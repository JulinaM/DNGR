...
# input 128 64 32 64  128 output
    ...
    autoencoder = Model(input_sh, decoded)
    ...
    train_generator = DataGenerator(batch_size, train_data, train_data)
    # train_generator.fit(train_data, train_data)
    val_generator = DataGenerator(batch_size, val_data, val_data)
...
def process_scripts(args):
    ...
    print_DGNR_model_parameters(filename, graph_type, Ksteps, alpha, hidden_layers, hidden_neurons)
...
def print_DGNR_model_parameters(filename, graph_type, Ksteps, alpha, hidden_layers, hidden_neurons):
    print("--------------------------------------------------")
    print("*** Parameters DNGR Model ***")
    print("Filename: \t", filename)
    print("Graph Type: \t", graph_type)
    print("(Random Surfing) Ksteps: \t", Ksteps)
    print("(PPMI) alpha: \t", alpha)
    print("(AutoEncoder) Hidden Layers: \t", hidden_layers)
    print("(AutoEncoder) Hidden Neurons: \t", hidden_neurons)
    print("--------------------------------------------------")
