...
print("*** Generating Adjacency matrix (EDGELIST) ***")
with open('wine.edgelist', 'wb') as f:
    nx.write_weighted_edgelist(data_edge, f)
print("Num GPUs Available: ", len(tf.config.experimental.list_physical_devices('GPU')))

print("*** Training DNGR (Deep Neural Network For Learning Graph Representation)  Model ***")
print("*** Data: wine.edgeList")

print("Calling ... \t DNGR Model")
subprocess.call(
    '~/PycharmProjects/DNGR-Keras/DNGR.py --graph_type ' + 'undirected' + ' --input ' + 'wine.edgelist' + ' --output ' + 'representation',
    shell=True)
